...
namespace ReplaceWithConstantBefore
{
    public static class AstronomyUtils
    {
        ...
        {
            return (9.81 * mass1 * mass2) / Math.Pow(distance, 2);
        }
        /// <summary>
        ...
        {
            return Math.Sqrt((4 * Math.Pow(3.14, 2) * Math.Pow(radius, 3)) / (9.81 * planetMass));
        }
        /// <summary>
        ...
        {
            return 9.81 * planetMass / Math.Pow(radius, 2);
        }
    }
}
